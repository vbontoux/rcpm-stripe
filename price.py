...
argParser.add_argument("-e", "--email", required = True, help="email du responsable")
argParser.add_argument("-t", "--telephone", required = True, help="téléphone du responsable")
argParser.add_argument("-p", "--price", required = True, help="prix total a payer")
